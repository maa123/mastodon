...
RSpec.describe StatusLengthValidator do
  describe '#validate' do
    before { stub_const("#{described_class}::MAX_CHARS", 2048) } # Example values below are relative to this baseline
